...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">✏️ Redigera sida</h1>
            <p class="text-gray-600 mt-2">Uppdatera {{ $page->page_name }}</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    >
                    <p class="text-xs text-gray-500 mt-1">Sidnyckeln kan inte ändras</p>
                </div>
                ...
                <div>
                    ...
                    <select 
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                        <option value="static" {{ old('page_type', $page->page_type) === 'static' ? 'selected' : '' }}>Statisk</option>
                        <option value="dynamic" {{ old('page_type', $page->page_type) === 'dynamic' ? 'selected' : '' }}>Dynamisk</option>
                        <option value="landing" {{ old('page_type', $page->page_type) === 'landing' ? 'selected' : '' }}>Landningssida</option>
                    </select>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    @if($page->og_image)
                        <div class="mb-3">
                            <img src="{{ Storage::url($page->og_image) }}" alt="Current OG Image" class="max-w-xs rounded-lg border border-gray-300">
                            <p class="text-xs text-gray-500 mt-1">Nuvarande bild (ladda upp en ny för att ersätta)</p>
                        </div>
                    @endif
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    @if($page->hero_image)
                        <div class="mb-3">
                            <img src="{{ Storage::url($page->hero_image) }}" alt="Current Hero Image" class="max-w-xs rounded-lg border border-gray-300">
                            <p class="text-xs text-gray-500 mt-1">Nuvarande bild (ladda upp en ny för att ersätta)</p>
                        </div>
                    @endif
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    >{{ old('sections', $page->sections ? json_encode($page->sections, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : '') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm"
                    >{{ old('features', $page->features ? json_encode($page->features, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : '') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm"
                    >{{ old('faqs', $page->faqs ? json_encode($page->faqs, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : '') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm"
                    >{{ old('testimonials', $page->testimonials ? json_encode($page->testimonials, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : '') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm"
                    >{{ old('schema_markup', $page->schema_markup ? json_encode($page->schema_markup, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : '') }}</textarea>
                </div>
            </div>
        </div>
