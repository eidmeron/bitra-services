...
class ServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'subscription_types.*' => 'in:daily,weekly,biweekly,monthly',
            'daily_multiplier' => 'nullable|numeric|min:0|max:2',
            'weekly_multiplier' => 'nullable|numeric|min:0|max:2',
            'biweekly_multiplier' => 'nullable|numeric|min:0|max:2',
            'monthly_multiplier' => 'nullable|numeric|min:0|max:2',
